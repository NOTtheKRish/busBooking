...
<html lang="en" data-bs-theme="auto">
    ...
    <title>Ticket Bookings - Bus Booking System</title>
  ...
  <div class="container py-4">
    ...
    <div class="p-3 mb-4 bg-body-tertiary rounded-5">
      <div class="container-fluid py-5">
        <h1 class="display-5 fw-bold">Ticket Bookings</h1>
        <p class="col-md-8 fs-4">Manage and view all Ticket Bookings of Bus Management System</p>
      </div>
    </div>
        ...
        <table class="table table-dark table-striped table-hover">
            ...
            <tbody>
                <?php
                    ...
                    $fetchAll = $ticketBooking->fetchAll();
