...
<html lang="en" data-bs-theme="auto">
    ...
    <title>Create Bus Route - Bus Booking System</title>
  ...
  <div class="container py-4">
    ...
    <div class="p-3 mb-4 bg-body-tertiary rounded-5">
      <div class="container-fluid py-5">
        <h1 class="display-5 fw-bold">New Bus Route</h1>
      </div>
    </div>
            ...
            <div class="form-row d-flex justify-content-evenly">
                ...
                <div class="form-group col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="boardingPoint">
                    </div>
                </div>
                <div class="form-group col-md-3">
                    <div class="mb-3">
                        <label for="boardingTime" class="form-label">Boarding Time</label>
                        <input type="time" class="form-control" id="boardingTime">
                    </div>
                </div>
            </div>
            <div class="form-row d-flex justify-content-evenly">
                ...
                <div class="form-group col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="droppingPoint">
                    </div>
                </div>
                <div class="form-group col-md-3">
                    <div class="mb-3">
                        <label for="droppingTime" class="form-label">Dropping Time</label>
                        <input type="time" class="form-control" id="droppingTime">
                    </div>
                </div>
            </div>
            <div class="form-row d-flex justify-content-evenly">
                <div class="form-group col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="eg: 9h 55m" id="duration">
                    </div>
                </div>
                <div class="form-group col-md-3">
                    <div class="mb-3">
                        <label for="fare" class="form-label">Fare</label>
                        <input type="number" step="0.1" class="form-control" id="fare">
                    </div>
                </div>
                <div class="form-group col-md-3">
                    <div class="mb-3">
            ...
            <div class="form-row text-center mt-5">
                <div class="form-group">
                    <div class="mb-3">
                        ...
                        <button class="btn btn-success d-flex mx-auto" name="create" id="create">Create</button>
                    </div>
                </div>
            </div>
        </div>
